...
{
    public class DrawableHishigataLanedHitObject : DrawableHishigataHitObject
    {
        public new HishigataLanedHitObject HitObject => (HishigataLanedHitObject)base.HitObject;
        protected override double InitialLifetimeOffset => HitObject.TimePreempt + (HitObject.IsFeign ? 200 : 0);

        protected Container Note;

        public DrawableHishigataLanedHitObject() : base(null)
        {
        }

        public DrawableHishigataLanedHitObject(HishigataHitObject hitObject = null)
            : base(hitObject)
        {
        }

        public Func<DrawableHishigataLanedHitObject, bool> CanBeHit;
