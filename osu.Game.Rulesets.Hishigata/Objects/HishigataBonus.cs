...
namespace osu.Game.Rulesets.Hishigata.Objects
{
    public class HishigataBonus : HishigataHitObject
    {
        ...
        private class BonusHitSampleInfo : HitSampleInfo, IEquatable<BonusHitSampleInfo>
        {
            ...
            public override HitSampleInfo With(Optional<string> newName = default, Optional<string> newBank = default, Optional<string?> newSuffix = default, Optional<int> newVolume = default, Optional<bool> newEditorAutoBank = default, Optional<bool> newUseBeatmapSamples = default)
